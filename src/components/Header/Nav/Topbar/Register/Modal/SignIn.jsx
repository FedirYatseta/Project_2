            ...
            <div>
                <form className="px-4 py-3" >
                    ...
                    <div className="mb-3 d-flex justify-content-between">
                        ...
                        <button className="btn btn-link" href="#section">Forgot password?</button>
                    </div>
                    <div className="d-grid gap-2">
                        <button type="submit" className="btn btn-success">Sign in</button>
                    </div>
                    <button type="button" className="btn btn-link text-decoration-none" >Don't have an account? Sign up</button>
                </form>
